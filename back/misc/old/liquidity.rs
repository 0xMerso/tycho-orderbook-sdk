...
pub trait ToLiquidityBook {
    fn structurate(&self, component: SrzProtocolComponent, tks: Vec<SrzToken>, query: OrderbookRequestParams, fee: f64, price: f64, poolb0: f64, poolb1: f64) -> LiquidityPoolBook;
}
...
pub async fn build(network: Network, datapools: Vec<ProtoTychoState>, tokens: Vec<SrzToken>, query: OrderbookRequestParams) -> PairLiquidityBook {
